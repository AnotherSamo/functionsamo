  ...
  <body>
    <div class="pos-f-t">
      ...
      <nav class="navbar navbar-light bg-light shadow p-3 mb-5 bg-white scale-in-ver-bottom">
        ...
        <a href="../views/editpageAdmin.php" class="btn btn-outline-success" type="submit"><svg
    ...
    <div align="center" class="container">
      ...
      <div id="saver" class="contenedor1 container bx-wrapper row d-flex justify-content-center">
        <img class="border border-dark" style="align-item:center; position:relative; z-index: -1;"
          src="plantillas/Pagina_1.png" alt="plantilla">
