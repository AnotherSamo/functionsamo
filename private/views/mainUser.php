...
<body>
  <div class="pos-f-t">
    <div class="collapse" id="navbarToggleExternalContent">
      <div class="bg-light p-4">
        ...
        <a href="faquser.php" class="mon-reg">Ayuda</a><br>
      </div>
    </div>
    ...
    <div class="float-child1 swing-in-top-fwd2">
      <div class="green">
        <div class="intern1 tracking-in-expand">
          ...
          <img src="../../public/img/icons/StudentIcon.png" alt="" width="75px" height="75px">
        </div>
        <div class="intern2 tracking-in-expand">
          <br>
          <?php
          $sqlu = "SELECT * FROM users WHERE  user_name LIKE '%$_SESSION[usuario]'";
          $Pack= mysqli_query($link, $sqlu);

          while ($filas = mysqli_fetch_assoc($Pack)) {
            $originalDate2 = $filas['created_at'];
            $newDate2 = date("d/m/Y", strtotime($originalDate2));

          ?>
          <p>Paquete: <?php echo $filas['package'] ?></p><br>
          
          <p>Fecha de Creación:  <?php echo $newDate2 ?></p><br>
          <?php
        }
    ...
    <div class="float-child3">
      <div class="green">
        <div class="intern3 scale-in-center">
          <a href=""><img src="../../public/img/icons/galeryIcon.png" alt="" width="50px" height="50px"></a>
          <p style="color: black;">Ver Fotolibro</p>
        </div>
        
        <div class="intern4 scale-in-center">
            <a href=""><img src="../../public/img/icons/addfotoIcon.png" alt="" width="50px" height="50px"></a>
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div><br>
      ...
      <a href="https://www.facebook.com/gado.estudio" target="_blank" class="btn btn-link btn-floating btn-lg text-reset me-4">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i> C. Teodoro Estrada 585, 47280 Bajío de San José, Jal.</p>
          <p>
            <i class="fas fa-envelope me-3"></i>
            <a href="mailto:studiosgado@gmail.com?Subject=INFORMACIÓN%20SOBRE%20SUS%20SERVICIOS">studiosgado@gmail.com</a>
          </p>
          <p><i class="fas fa-phone me-3"></i>(475) 741 2916</p>
          <p><i class="fas fa-print me-3"></i>(449) 537 8188</p><br>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
