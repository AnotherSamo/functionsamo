                ...
                <div class="container col-auto">
                    <table id="cargar" class="table table-stripped table-bordered">
                        ...
                        <thead>
                            ...
                            $arreglo= $consulta['id_user'].','.$consulta['name'].','.$consulta['package'].','.$consulta['current_pages'].','.$consulta['address'];
                            ?>
                            <tbody>
                            ...
                            <td> 
                            <a class="btn btn-primary rounded" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
