  ...
  <body>
    <div class="pos-f-t">
      <div class="collapse" id="navbarToggleExternalContent">
        <div class="bg-light p-4">
          ...
          <a href="../code/reset-password.php" class="mon-reg">Cambia tu contraseña</a><br>
    ...
    <div class="float-child2 swing-in-top-fwd">
      <div class="blue tracking-in-contract-bck">
        ...
        ?>
          <div class="btn-group">
            <button type="button" class="btn btn-success" style="margin: 5px;"><?php echo $name_school['name'] ?></button>
              <br><br>
          </div>
        <?php
        }
